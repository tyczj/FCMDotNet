...
namespace PushNotifications
{
    public class PushMessage
    {
        ...
        /// For more information about notification message and data message options, see https://firebase.google.com/docs/cloud-messaging/concept-options#notifications_and_data_messages
        /// </summary>
